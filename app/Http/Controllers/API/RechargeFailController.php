...
use App\Models\RechargeFailCase;
...
class RechargeFailController extends Controller
{
    /**
        ...
        public function index(Request $request): JsonResponse
    {
          try {
            ...
            $rechargefailcases = $query->orderBy('created_at', 'desc')
                                         ->paginate($perPage);

            return response()->json([
                'status' => 'success',
                'message' => 'Recharge success cases retrieved successfully',
                'data' => $rechargefailcases->items(),
                'pagination' => [
                    'current_page' => $rechargefailcases->currentPage(),
                    'last_page' => $rechargefailcases->lastPage(),
                    'per_page' => $rechargefailcases->perPage(),
                    'total' => $rechargefailcases->total(),
                ]
            ]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $rechargefailcase = RechargeFailCase::create([
                'op' => $request->op,
 ...
 public function show($id): JsonResponse
    {
        try {
            $rechargefailcase = RechargeFailCase::findOrFail($id);
