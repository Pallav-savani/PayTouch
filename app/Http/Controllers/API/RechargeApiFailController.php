...
use App\Models\RechargeApiFail;
...
class RechargeApiFailController extends Controller
{
    /**
        ...
        public function index(Request $request): JsonResponse
    {
          try {
            ...
            $rechargeapifail = $query->orderBy('created_at', 'desc')
                                         ->paginate($perPage);

            return response()->json([
                'status' => 'success',
                'message' => 'Recharge API success retrieved successfully',
                'data' => $rechargeapifail->items(),
                'pagination' => [
                    'current_page' => $rechargeapifail->currentPage(),
                    'last_page' => $rechargeapifail->lastPage(),
                    'per_page' => $rechargeapifail->perPage(),
                    'total' => $rechargeapifail->total(),
                ]
            ]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $rechargeapifail = RechargeApiFail::create([
                'op' => $request->op,
            ...
            Log::info('Recharge API Fail Created', [
                'status' => 'Fail',
                'message' => 'Recharge API fail',
                'data' => $rechargeapifail
            ]);
 ...
 public function show($id): JsonResponse
    {
        try {
            $dthRecharge = RechargeApiFail::findOrFail($id);
   ...
   public function update(Request $request, string $id): JsonResponse
    {
        try {
            $rechargeSuccessCase = RechargeApiFail::findOrFail($id);
