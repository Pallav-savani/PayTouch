...
use App\Models\RechargeSuccessCase;
...
class RechargeSuccessController extends Controller
{
    /**
    ...
    {
          try {
            $query = RechargeSuccessCase::query();
            ...
            $rechargeSuccessCases = $query->orderBy('created_at', 'desc')
                                         ->paginate($perPage);

            return response()->json([
                'status' => 'success',
                'message' => 'Recharge success cases retrieved successfully',
                'data' => $rechargeSuccessCases->items(),
                'pagination' => [
                    'current_page' => $rechargeSuccessCases->currentPage(),
                    'last_page' => $rechargeSuccessCases->lastPage(),
                    'per_page' => $rechargeSuccessCases->perPage(),
                    'total' => $rechargeSuccessCases->total(),
                ]
            ]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $rechargeSuccessCase = RechargeSuccessCase::create([
                'op' => $request->op,
 ...
 public function show($id): JsonResponse
    {
        try {
            $dthRecharge = RechargeSuccessCase::findOrFail($id);
   ...
   public function update(Request $request, string $id): JsonResponse
    {
        try {
            $rechargeSuccessCase = RechargeSuccessCase::findOrFail($id);
