...
use App\Models\RechargeApiSuccess;
...
class RechargeApiSuccessController extends Controller
{
    ...
    {
          try {
            $query = RechargeApiSuccess::query();
            ...
            $rechargeapisuccesscases = $query->orderBy('created_at', 'desc')
                                         ->paginate($perPage);

            return response()->json([
                'status' => 'success',
                'message' => 'Recharge API success retrieved successfully',
                'data' => $rechargeapisuccesscases->items(),
                'pagination' => [
                    'current_page' => $rechargeapisuccesscases->currentPage(),
                    'last_page' => $rechargeapisuccesscases->lastPage(),
                    'per_page' => $rechargeapisuccesscases->perPage(),
                    'total' => $rechargeapisuccesscases->total(),
                ]
            ]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $rechargeapisuccesscases = RechargeApiSuccess::create([
                'op' => $request->op,
 ...
 public function show($id): JsonResponse
    {
        try {
            $dthRecharge = RechargeApiSuccess::findOrFail($id);
   ...
   public function update(Request $request, string $id): JsonResponse
    {
        try {
            $rechargeSuccessCase = RechargeApiSuccess::findOrFail($id);
