...
use App\Models\RechargePendingCase;
...
class RechargePendingController extends Controller
{
    /**
    ...
    {
          try {
            $query = RechargePendingCase::query();
            ...
            $rechargependingcases = $query->orderBy('created_at', 'desc')
                                         ->paginate($perPage);

            return response()->json([
                'status' => 'success',
                'message' => 'Recharge success cases retrieved successfully',
                'data' => $rechargependingcases->items(),
                'pagination' => [
                    'current_page' => $rechargependingcases->currentPage(),
                    'last_page' => $rechargependingcases->lastPage(),
                    'per_page' => $rechargependingcases->perPage(),
                    'total' => $rechargependingcases->total(),
                ]
            ]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $rechargependingcases = RechargePendingCase::create([
                'op' => $request->op,
 ...
 public function show($id): JsonResponse
    {
        try {
            $dthRecharge = RechargePendingCase::findOrFail($id);
   ...
   public function update(Request $request, string $id): JsonResponse
    {
        try {
            $rechargependingcases = RechargePendingCase::findOrFail($id);
            ...
            return response()->json([
                'status' => 'success',
                'message' => 'Recharge success case updated successfully',
                'data' => $rechargependingcases->fresh()
            ]);
