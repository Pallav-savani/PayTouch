...
return new class extends Migration
{
    ...
    {
        Schema::create('recharge_success_case', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['success', 'pending', 'resolved'])->default('success');  // Default status set to 'success'
    ...
    {
        Schema::dropIfExists('recharge_success_case');
    }
};
