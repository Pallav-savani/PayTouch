...
return new class extends Migration
{
    ...
    {
        Schema::create('recharge_pending_case', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['pending', 'fail', 'resolved'])->default('pending'); // Default status set to 'success'
    ...
    {
        Schema::dropIfExists('recharge_pending_case');
    }
};
