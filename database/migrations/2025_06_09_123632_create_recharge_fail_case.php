...
return new class extends Migration
{
    ...
    {
        Schema::create('recharge_fail_case', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('view_bill')->nullable(); // Transaction ID from recharges table
                  $table->enum('status', ['fail', 'pending', 'resolved'])->default('fail'); // Default status set to 'success'
    ...
    {
        Schema::dropIfExists('recharge_fail_case');
    }
};
