    ...
    <div class="row martop">
        ...
        <div id="divService" class="martop10"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <form id="historyFilterForm" class="p-0">
                            <div class="row service">
                                <div class="mb-3" style="text-align:left;">
                                    <label for="historyFromDate" class="form-label">From Date</label>
                                    <input type="date" class="form-control" id="historyFromDate" name="from_date" required>
                                    <small class="form-text text-muted">Select start date</small>
                                </div>
                                <div class="mb-3">
                                    <label for="historyToDate" class="form-label">To Date</label>
                                    <input type="date" class="form-control" id="historyToDate" name="to_date" required>
                                    <small class="form-text text-muted">Select end date</small>
                                </div>
                                <div class="mb-3">
                                    <label for="historyOperator" class="form-label">Select Operator</label>
                                    <select name="historyOperator" id="historyOperator" class="form-select">
                                        <option value="">-- Select Operator --</option>
                                        <option value="airtel">AIRTEL</option>
                                        <option value="jio">JIO</option>
                                        <option value="vi">VI</option>
                                ...
                                <div class="mb-3">
                                    <label for="historyStatus" class="form-label">Select Status</label>
                                    <select name="historyStatus" id="historyStatus" class="form-select">
                                ...
                                <div class="mb-3 w-100 d-flex align-items-center justify-content-end">
                                    <button type="button" class="rounded" id="resetHistoryBtn">Reset Filters</button>
                                </div>
                                <div class="mb-3">
                                    <button type="submit" class="col-12 rounded" id="searchHistoryBtn">
                                        <span id="historyBtnText">Search History</span>
                                        <span id="historyBtnSpinner" class="spinner-border spinner-border-sm d-none" role="status"></span>
                                    </button>
                                </div>
                            </div>
                        </form>
                        <div id="historyAlertContainer"></div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="historyTableBody">
                                    <tr><td colspan="7" class="text-center">Select dates and click Search to load history</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
    ...
    <div class="row martop">
        ...
        <div id="divService" class="martop10"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <form id="searchForm" class="p-0">
                            <div class="row service">
                                <div class="mb-3" style="text-align:left;">
                                    <label for="searchMobileNo" class="form-label">Mobile No.</label>
                                    <input name="searchMobileNo" type="tel" class="form-control" id="searchMobileNo" placeholder="Enter mobile number" pattern="[0-9]{10}" maxlength="10">
                                    <small class="form-text text-muted">Enter 10-digit mobile number</small>
                                </div>
                                <div class="mb-3">
                                    <label for="searchTxnId" class="form-label">Transaction ID</label>
                                    <input name="searchTxnId" type="text" class="form-control" id="searchTxnId" placeholder="Enter transaction ID">
                                    <small class="form-text text-muted">Enter transaction ID to search</small>
                                </div>
                                <div class="mb-3 w-100 d-flex align-items-center justify-content-end">
                                    <button type="button" class="rounded" id="resetSearchBtn">Reset Search</button>
                                </div>
                                <div class="mb-3">
                                    <button type="submit" class="col-12 rounded" id="searchBtn">
                                        <span id="searchBtnText">Search Records</span>
